...
1. **Download**: [EduRAGTutor-Setup-1.2.1.exe](https://github.com/qinjin1021/Edu-RAG-Tutor/releases/download/v1.2.1/EduRAGTutor-Setup-1.2.1.exe) (~350 MB)
...
- `installer\EduRAGTutor-Setup-1.2.1.exe` — distributable installer (users enter their own API key on first launch)
